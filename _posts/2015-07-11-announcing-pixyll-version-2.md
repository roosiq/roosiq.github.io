...
// <![CDATA[
  ...
  var adUnitOptions = adUnitOptions || {
      ...
      publisherId: 'ca-pub-8642148860303121',
  ...
  var mapData = [
      ...
      new google.maps.LatLng(parseFloat("41.1336".replace(",", ".")),parseFloat("-8.61740000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("52.2125".replace(",", ".")),parseFloat("6.86410000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("41.4477".replace(",", ".")),parseFloat("-70.62100000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("27.8223".replace(",", ".")),parseFloat("-82.27970000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("-36.85".replace(",", ".")),parseFloat("174.76500000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("31.1064".replace(",", ".")),parseFloat("-97.40710000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("40.9157".replace(",", ".")),parseFloat("-81.13300000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("40.7104".replace(",", ".")),parseFloat("-74.21110000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("40.5512".replace(",", ".")),parseFloat("-109.56960000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("20.65".replace(",", ".")),parseFloat("-103.31670000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("39.9494".replace(",", ".")),parseFloat("-75.14570000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("28.6667".replace(",", ".")),parseFloat("77.43330000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("45.5167".replace(",", ".")),parseFloat("-74.65000000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("39.7926".replace(",", ".")),parseFloat("-86.25510000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("41.1532".replace(",", ".")),parseFloat("-85.48100000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("-33.6821".replace(",", ".")),parseFloat("150.91540000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("50.7362".replace(",", ".")),parseFloat("7.10020000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("40.5961".replace(",", ".")),parseFloat("-73.97320000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("37.918".replace(",", ".")),parseFloat("-122.30320000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("40.3245".replace(",", ".")),parseFloat("-111.96180000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("21.0333".replace(",", ".")),parseFloat("105.85000000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.4661".replace(",", ".")),parseFloat("-118.57470000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.8".replace(",", ".")),parseFloat("-79.41670000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-37.8362".replace(",", ".")),parseFloat("145.19430000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.0731".replace(",", ".")),parseFloat("-89.40120000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("19.2883".replace(",", ".")),parseFloat("-99.66720000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("49.2603".replace(",", ".")),parseFloat("-123.14600000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-34.9514".replace(",", ".")),parseFloat("138.56700000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("45.0724".replace(",", ".")),parseFloat("-93.18740000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.4757".replace(",", ".")),parseFloat("-79.65910000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.7143".replace(",", ".")),parseFloat("-74.00600000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.888".replace(",", ".")),parseFloat("-118.13040000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("17.3753".replace(",", ".")),parseFloat("78.47440000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("44.662".replace(",", ".")),parseFloat("-63.60170000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("29.7527".replace(",", ".")),parseFloat("-95.40990000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("36.1443".replace(",", ".")),parseFloat("-115.18300000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("35.4478".replace(",", ".")),parseFloat("139.64250000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("49.322".replace(",", ".")),parseFloat("-123.11490000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("35.0911".replace(",", ".")),parseFloat("-89.65100000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("68.35".replace(",", ".")),parseFloat("-133.70000000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("48.1414".replace(",", ".")),parseFloat("11.50200000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("49.0997".replace(",", ".")),parseFloat("-122.65260000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-33.7833".replace(",", ".")),parseFloat("150.78330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.7904".replace(",", ".")),parseFloat("-74.02460000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-33.8834".replace(",", ".")),parseFloat("151.15620000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("47.5839".replace(",", ".")),parseFloat("-122.29950000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("41.6033".replace(",", ".")),parseFloat("-87.75470000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.0306".replace(",", ".")),parseFloat("-96.99260000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.0674".replace(",", ".")),parseFloat("-118.24230000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("42.7423".replace(",", ".")),parseFloat("-86.06610000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.8314".replace(",", ".")),parseFloat("-72.97580000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("37.3885".replace(",", ".")),parseFloat("-122.07410000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.9944".replace(",", ".")),parseFloat("-118.46380000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("30.0378".replace(",", ".")),parseFloat("-95.53260000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("44.9822".replace(",", ".")),parseFloat("-92.69950000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("42.1343".replace(",", ".")),parseFloat("-72.42330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("52.1885".replace(",", ".")),parseFloat("-2.24700000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("52.1885".replace(",", ".")),parseFloat("-2.24700000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("19.45".replace(",", ".")),parseFloat("-70.70000000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("52.5167".replace(",", ".")),parseFloat("13.40000000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("53.4179".replace(",", ".")),parseFloat("-113.57850000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("48.9381".replace(",", ".")),parseFloat("2.49400000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.1073".replace(",", ".")),parseFloat("-118.37190000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.5516".replace(",", ".")),parseFloat("-74.46370000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.4757".replace(",", ".")),parseFloat("-79.65910000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("47.7396".replace(",", ".")),parseFloat("-122.34260000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-37.8".replace(",", ".")),parseFloat("145.28330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("39.993".replace(",", ".")),parseFloat("-82.99850000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.0115".replace(",", ".")),parseFloat("-117.85350000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.4835".replace(",", ".")),parseFloat("-74.44320000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.5767".replace(",", ".")),parseFloat("-73.99000000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("42.9742".replace(",", ".")),parseFloat("-85.93110000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("47.7396".replace(",", ".")),parseFloat("-122.34260000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("32.9588".replace(",", ".")),parseFloat("-96.98120000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("41.7048".replace(",", ".")),parseFloat("-111.87090000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("35.1091".replace(",", ".")),parseFloat("-106.58070000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.6555".replace(",", ".")),parseFloat("-79.36260000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("25.2867".replace(",", ".")),parseFloat("51.53330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("29.7397".replace(",", ".")),parseFloat("-95.83020000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.1125".replace(",", ".")),parseFloat("-88.24260000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("25.0833".replace(",", ".")),parseFloat("-77.35000000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("39.2952".replace(",", ".")),parseFloat("-76.62310000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("45.7333".replace(",", ".")),parseFloat("-76.60000000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.7214".replace(",", ".")),parseFloat("-74.00520000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-31.9344".replace(",", ".")),parseFloat("115.87160000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.1394".replace(",", ".")),parseFloat("-80.23570000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("37.7217".replace(",", ".")),parseFloat("-122.44440000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("39.1148".replace(",", ".")),parseFloat("-77.24620000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.0995".replace(",", ".")),parseFloat("-117.58080000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.6009".replace(",", ".")),parseFloat("-73.93970000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.9069".replace(",", ".")),parseFloat("-79.26950000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("48.4496".replace(",", ".")),parseFloat("-123.30260000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("51.2021".replace(",", ".")),parseFloat("-114.24530000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.0995".replace(",", ".")),parseFloat("-117.58080000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("35.7362".replace(",", ".")),parseFloat("-80.19310000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.0139".replace(",", ".")),parseFloat("-71.43520000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-27.6876".replace(",", ".")),parseFloat("153.08440000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("36.7505".replace(",", ".")),parseFloat("-119.67330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("44.1843".replace(",", ".")),parseFloat("-88.53050000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("42.2618".replace(",", ".")),parseFloat("-71.80280000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.8651".replace(",", ".")),parseFloat("-84.89480000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-36.85".replace(",", ".")),parseFloat("174.76500000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("51.2021".replace(",", ".")),parseFloat("-114.24530000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.7518".replace(",", ".")),parseFloat("-74.06620000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("52.1885".replace(",", ".")),parseFloat("-2.24700000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("45.3548".replace(",", ".")),parseFloat("-75.57730000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("29.6766".replace(",", ".")),parseFloat("-82.38550000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("25.6615".replace(",", ".")),parseFloat("-80.41200000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("39.645".replace(",", ".")),parseFloat("-106.59420000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("19.4342".replace(",", ".")),parseFloat("-99.13860000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("49.867".replace(",", ".")),parseFloat("-97.13560000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.4835".replace(",", ".")),parseFloat("-74.44320000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("35.8713".replace(",", ".")),parseFloat("-78.53940000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.6987".replace(",", ".")),parseFloat("-74.32960000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("38.6501".replace(",", ".")),parseFloat("-121.25340000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("52.5167".replace(",", ".")),parseFloat("13.40000000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("37.9833".replace(",", ".")),parseFloat("23.73330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.8038".replace(",", ".")),parseFloat("-86.61890000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.9002".replace(",", ".")),parseFloat("-79.26760000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-31.955".replace(",", ".")),parseFloat("115.83590000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.4341".replace(",", ".")),parseFloat("-88.35650000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("38.9379".replace(",", ".")),parseFloat("-9.32760000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.6242".replace(",", ".")),parseFloat("-81.93900000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.2205".replace(",", ".")),parseFloat("-77.87020000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.7622".replace(",", ".")),parseFloat("-73.91210000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.8661".replace(",", ".")),parseFloat("-118.05280000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("38.4468".replace(",", ".")),parseFloat("-122.78410000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("36.3769".replace(",", ".")),parseFloat("-119.18440000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("48.4167".replace(",", ".")),parseFloat("-123.36500000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("29.9589".replace(",", ".")),parseFloat("-90.15680000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.7449".replace(",", ".")),parseFloat("-73.97820000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.8016".replace(",", ".")),parseFloat("-79.32160000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("45.3548".replace(",", ".")),parseFloat("-75.57730000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("38.7213".replace(",", ".")),parseFloat("-76.53110000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-32.9028".replace(",", ".")),parseFloat("151.69070000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("51.7136".replace(",", ".")),parseFloat("8.75540000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.7421".replace(",", ".")),parseFloat("-74.00180000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.4757".replace(",", ".")),parseFloat("-79.65910000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("39.1312".replace(",", ".")),parseFloat("-84.55810000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.7904".replace(",", ".")),parseFloat("-74.02460000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-37.9457".replace(",", ".")),parseFloat("145.15810000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-33.7893".replace(",", ".")),parseFloat("150.88160000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("42.9875".replace(",", ".")),parseFloat("-82.46660000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("36.2871".replace(",", ".")),parseFloat("-87.69130000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.2205".replace(",", ".")),parseFloat("-77.87020000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("46.8582".replace(",", ".")),parseFloat("-113.98960000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("30.5174".replace(",", ".")),parseFloat("-97.63040000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.3456".replace(",", ".")),parseFloat("-80.13420000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("59.3333".replace(",", ".")),parseFloat("18.05000000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.5677".replace(",", ".")),parseFloat("-80.24180000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("32.9588".replace(",", ".")),parseFloat("-96.98120000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("49.3397".replace(",", ".")),parseFloat("-123.19120000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.5961".replace(",", ".")),parseFloat("-73.97320000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("49.2755".replace(",", ".")),parseFloat("-123.12520000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-1.2833".replace(",", ".")),parseFloat("116.83330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("42.7084".replace(",", ".")),parseFloat("-71.14350000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("49.0423".replace(",", ".")),parseFloat("-122.28350000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-37.7974".replace(",", ".")),parseFloat("175.26040000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("59.9167".replace(",", ".")),parseFloat("10.75000000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.827".replace(",", ".")),parseFloat("-73.93840000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("45.8862".replace(",", ".")),parseFloat("11.01990000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.5363".replace(",", ".")),parseFloat("-117.04390000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("37.7799".replace(",", ".")),parseFloat("-121.97800000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("46.2676".replace(",", ".")),parseFloat("-80.90630000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("51.3359".replace(",", ".")),parseFloat("-0.07780000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-6.1744".replace(",", ".")),parseFloat("106.82940000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("32.8561".replace(",", ".")),parseFloat("-116.99680000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.7588".replace(",", ".")),parseFloat("-73.96800000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("53.0".replace(",", ".")),parseFloat("-2.18330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("47.8435".replace(",", ".")),parseFloat("-122.19570000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.7542".replace(",", ".")),parseFloat("-118.20190000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-40.3658".replace(",", ".")),parseFloat("175.58850000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("49.1155".replace(",", ".")),parseFloat("6.17590000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("41.7672".replace(",", ".")),parseFloat("-8.58390000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("33.6518".replace(",", ".")),parseFloat("-117.18230000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("13.6".replace(",", ".")),parseFloat("100.71670000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("42.473".replace(",", ".")),parseFloat("-71.09820000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.1974".replace(",", ".")),parseFloat("-118.60150000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("37.7333".replace(",", ".")),parseFloat("-122.24200000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-31.9522".replace(",", ".")),parseFloat("115.86140000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.6248".replace(",", ".")),parseFloat("-112.42200000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.1409".replace(",", ".")),parseFloat("-87.94970000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.6248".replace(",", ".")),parseFloat("-112.42200000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.9638".replace(",", ".")),parseFloat("-118.27340000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.7328".replace(",", ".")),parseFloat("-79.79530000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("40.2262".replace(",", ".")),parseFloat("-75.29310000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.8217".replace(",", ".")),parseFloat("-74.15740000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("39.9653".replace(",", ".")),parseFloat("-83.02350000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("37.4249".replace(",", ".")),parseFloat("-122.00740000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.3456".replace(",", ".")),parseFloat("-80.13420000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("35.6767".replace(",", ".")),parseFloat("-81.38500000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.8661".replace(",", ".")),parseFloat("-118.05280000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("49.1836".replace(",", ".")),parseFloat("-123.11680000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("59.9167".replace(",", ".")),parseFloat("10.75000000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.8309".replace(",", ".")),parseFloat("-73.90700000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("41.2917".replace(",", ".")),parseFloat("-96.17110000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("39.9653".replace(",", ".")),parseFloat("-83.02350000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("39.1748".replace(",", ".")),parseFloat("-77.53260000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-37.9".replace(",", ".")),parseFloat("145.08330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("37.2555".replace(",", ".")),parseFloat("-121.92450000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.6987".replace(",", ".")),parseFloat("-74.32960000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.8038".replace(",", ".")),parseFloat("-86.61890000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("42.6241".replace(",", ".")),parseFloat("-71.33890000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("39.0032".replace(",", ".")),parseFloat("-77.16020000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.4757".replace(",", ".")),parseFloat("-79.65910000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("37.3486".replace(",", ".")),parseFloat("-121.95100000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.6944".replace(",", ".")),parseFloat("-73.99060000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.6944".replace(",", ".")),parseFloat("-73.99060000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.6944".replace(",", ".")),parseFloat("-73.99060000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("48.0585".replace(",", ".")),parseFloat("-122.14820000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.6944".replace(",", ".")),parseFloat("-73.99060000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("46.744".replace(",", ".")),parseFloat("-92.57390000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.7354".replace(",", ".")),parseFloat("-73.87830000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("37.3486".replace(",", ".")),parseFloat("-121.95100000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("44.2569".replace(",", ".")),parseFloat("-76.47170000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("32.6606".replace(",", ".")),parseFloat("-97.02490000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("39.9729".replace(",", ".")),parseFloat("-87.62180000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("51.5125".replace(",", ".")),parseFloat("7.47700000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("39.5996".replace(",", ".")),parseFloat("-74.36870000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("41.5755".replace(",", ".")),parseFloat("-83.68470000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("37.2555".replace(",", ".")),parseFloat("-121.92450000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("26.1209".replace(",", ".")),parseFloat("-80.12730000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("29.3697".replace(",", ".")),parseFloat("47.97830000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.283".replace(",", ".")),parseFloat("-74.71510000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("29.8327".replace(",", ".")),parseFloat("-95.66270000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("45.4448".replace(",", ".")),parseFloat("-75.64310000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.6789".replace(",", ".")),parseFloat("-73.44740000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("10.0739".replace(",", ".")),parseFloat("-69.32280000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("44.2569".replace(",", ".")),parseFloat("-76.47170000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-34.0".replace(",", ".")),parseFloat("150.86670000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-6.1744".replace(",", ".")),parseFloat("106.82940000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("28.7313".replace(",", ".")),parseFloat("-81.51580000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.6662".replace(",", ".")),parseFloat("-79.52820000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.1647".replace(",", ".")),parseFloat("-79.82400000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("33.5007".replace(",", ".")),parseFloat("-111.98290000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("44.7631".replace(",", ".")),parseFloat("-85.62060000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.8808".replace(",", ".")),parseFloat("-80.35360000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("41.5748".replace(",", ".")),parseFloat("-70.62750000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.8859".replace(",", ".")),parseFloat("-74.04680000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.6662".replace(",", ".")),parseFloat("-79.52820000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-37.769".replace(",", ".")),parseFloat("145.04310000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("29.0667".replace(",", ".")),parseFloat("-110.96670000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.6656".replace(",", ".")),parseFloat("-79.38300000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("49.8143".replace(",", ".")),parseFloat("-97.15310000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("38.7591".replace(",", ".")),parseFloat("-77.09510000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-27.4432".replace(",", ".")),parseFloat("153.03020000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("38.6027".replace(",", ".")),parseFloat("-121.26870000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.5007".replace(",", ".")),parseFloat("-111.98290000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.9002".replace(",", ".")),parseFloat("-79.26760000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.9364".replace(",", ".")),parseFloat("9.17480000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("52.4107".replace(",", ".")),parseFloat("-1.81950000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("49.0".replace(",", ".")),parseFloat("2.38330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("29.0667".replace(",", ".")),parseFloat("-110.96670000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.6404".replace(",", ".")),parseFloat("-79.39950000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("32.8897".replace(",", ".")),parseFloat("-117.13360000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("44.069".replace(",", ".")),parseFloat("-123.08250000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("44.0001".replace(",", ".")),parseFloat("-79.46630000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.447".replace(",", ".")),parseFloat("-80.47250000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-37.769".replace(",", ".")),parseFloat("145.04310000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("46.5168".replace(",", ".")),parseFloat("-84.33330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.7354".replace(",", ".")),parseFloat("-73.87830000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.8483".replace(",", ".")),parseFloat("-73.97250000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("36.2729".replace(",", ".")),parseFloat("-115.13330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("49.3397".replace(",", ".")),parseFloat("-123.19120000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.9188".replace(",", ".")),parseFloat("-84.06780000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("47.6636".replace(",", ".")),parseFloat("-122.38040000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("37.6624".replace(",", ".")),parseFloat("-121.87470000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("48.1725".replace(",", ".")),parseFloat("11.59640000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("35.2268".replace(",", ".")),parseFloat("-78.95620000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("26.212".replace(",", ".")),parseFloat("-80.26690000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("42.2873".replace(",", ".")),parseFloat("-71.35240000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("35.1988".replace(",", ".")),parseFloat("-106.70350000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("40.6749".replace(",", ".")),parseFloat("-73.81910000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("42.3241".replace(",", ".")),parseFloat("-83.71130000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("38.6501".replace(",", ".")),parseFloat("-121.25340000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("51.0833".replace(",", ".")),parseFloat("-114.08330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("39.9653".replace(",", ".")),parseFloat("-83.02350000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.6383".replace(",", ".")),parseFloat("-96.72450000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.9791".replace(",", ".")),parseFloat("-84.14940000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("26.212".replace(",", ".")),parseFloat("-80.26690000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-33.8278".replace(",", ".")),parseFloat("151.23330000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("41.55".replace(",", ".")),parseFloat("-88.12480000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.6383".replace(",", ".")),parseFloat("-96.72450000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("35.029".replace(",", ".")),parseFloat("-89.78220000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("22.2833".replace(",", ".")),parseFloat("114.15000000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("10.95".replace(",", ".")),parseFloat("78.08330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("45.5774".replace(",", ".")),parseFloat("-122.62080000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-10.9167".replace(",", ".")),parseFloat("-37.06670000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("37.7721".replace(",", ".")),parseFloat("-90.36720000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.5975".replace(",", ".")),parseFloat("-73.99790000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("41.9656".replace(",", ".")),parseFloat("-71.32570000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("28.6333".replace(",", ".")),parseFloat("-106.08330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("50.1264".replace(",", ".")),parseFloat("8.70890000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("43.7113".replace(",", ".")),parseFloat("-79.41950000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("41.9986".replace(",", ".")),parseFloat("-87.90280000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("35.2565".replace(",", ".")),parseFloat("-120.62140000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.6451".replace(",", ".")),parseFloat("-73.94500000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("48.8729".replace(",", ".")),parseFloat("9.27570000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.7474".replace(",", ".")),parseFloat("-117.99390000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.4881".replace(",", ".")),parseFloat("-79.70980000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("33.4442".replace(",", ".")),parseFloat("-112.31780000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-20.45".replace(",", ".")),parseFloat("-54.61670000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.6974".replace(",", ".")),parseFloat("-111.99610000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("40.1246".replace(",", ".")),parseFloat("-75.53850000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.6655".replace(",", ".")),parseFloat("-79.43780000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("20.6667".replace(",", ".")),parseFloat("-103.33330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("45.4897".replace(",", ".")),parseFloat("-73.79580000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-37.8".replace(",", ".")),parseFloat("145.28330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("53.6585".replace(",", ".")),parseFloat("-113.36140000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("47.0056".replace(",", ".")),parseFloat("28.85750000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("33.5597".replace(",", ".")),parseFloat("133.53110000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.0881".replace(",", ".")),parseFloat("-117.46480000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("36.9358".replace(",", ".")),parseFloat("-119.56340000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("53.6585".replace(",", ".")),parseFloat("-113.36140000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-6.1744".replace(",", ".")),parseFloat("106.82940000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("39.3405".replace(",", ".")),parseFloat("-76.49620000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("29.9822".replace(",", ".")),parseFloat("-95.17760000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("31.973".replace(",", ".")),parseFloat("-81.08400000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.3806".replace(",", ".")),parseFloat("-79.88600000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("42.3955".replace(",", ".")),parseFloat("-71.18160000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.2313".replace(",", ".")),parseFloat("-79.90490000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("28.2887".replace(",", ".")),parseFloat("-81.32040000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-35.276".replace(",", ".")),parseFloat("149.13440000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("46.6288".replace(",", ".")),parseFloat("-87.47960000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("39.6172".replace(",", ".")),parseFloat("-75.86780000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.2731".replace(",", ".")),parseFloat("-83.89050000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("45.4667".replace(",", ".")),parseFloat("-73.88330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("45.5774".replace(",", ".")),parseFloat("-122.62080000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-32.0976".replace(",", ".")),parseFloat("115.81920000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("36.175".replace(",", ".")),parseFloat("-115.13720000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("35.2985".replace(",", ".")),parseFloat("-111.32520000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("37.3486".replace(",", ".")),parseFloat("-121.95100000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("50.1026".replace(",", ".")),parseFloat("8.68950000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("21.3469".replace(",", ".")),parseFloat("-158.01830000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("43.225".replace(",", ".")),parseFloat("-79.98000000".replace(",", "."))),
      ...
      new google.maps.LatLng(parseFloat("49.17".replace(",", ".")),parseFloat("-123.13680000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("51.529".replace(",", ".")),parseFloat("7.48020000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("-26.3".replace(",", ".")),parseFloat("-48.83330000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("42.3367".replace(",", ".")),parseFloat("-7.86410000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.1019".replace(",", ".")),parseFloat("-117.27620000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("34.0311".replace(",", ".")),parseFloat("-118.49000000".replace(",", "."))),
    
      new google.maps.LatLng(parseFloat("48.1558".replace(",", ".")),parseFloat("11.54090000".replace(",", "."))),
  ...
  function initialize() {
    ...
    // if on mobile, don't show ads
    if(parseInt(size[0][0]) > 320 || size[0][0] == 'large') {
        var adUnitDiv = document.createElement('div');
        adUnitOptions['map'] = map;
    ...
    heatmap = new google.maps.visualization.HeatmapLayer({
      ...
      var gradient = [
        ...
        heatmap.setMap(map);
        heatmap.setOptions({radius: init_radius, opacity: 0.9, gradient: gradient});

        google.maps.event.addListener(map, 'zoom_changed', function() {
            new_radius = Math.round(init_radius * Math.pow(1.8, Math.abs(map.getZoom() - zoomlevel)));
            heatmap.setOptions({radius: new_radius});
        });
